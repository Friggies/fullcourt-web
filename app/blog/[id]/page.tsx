    ...
    <>
      ...
      <Section>
        ...
        {!isPremium && (
          <Link
            href="/pricing"
            className="mt-2 w-full bg-muted text-muted-foreground rounded-full underline p-2 text-sm text-center"
          >
            Support{' '}
            <span className="uppercase font-semibold">Fullcourt Training</span>{' '}
            by&nbsp;going&nbsp;Premium
          </Link>
        )}

        <article className="mt-4 prose prose-neutral dark:prose-invert max-w-none">
